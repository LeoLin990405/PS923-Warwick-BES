---
title: "Zhongyuelin_Week1_Homework"
author: "Zhongyuelin"
date: "2022-10-08"
output:
  pdf_document: 
...
salaries_prof=data.frame(filter(Salaries,rank=="Prof"))
salaries_prof_0year=data.frame(filter(salaries_prof,yrs.service==0))
nrow(salaries_prof_0year)/nrow(salaries_prof)
```
...
Salaries[ , 'luck'] = (sample(1:6,397,replace = T))
head(Salaries)
```
